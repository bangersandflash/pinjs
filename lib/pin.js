...
var Pin = function(options) {
  ...
  this.addCardToCustomer = function (token, fields, callback) {
    var req = request.post(options.url + '/1/customers/' + token + '/cards');
    generateRequest(req, fields, callback);
  };
  ...
  this.updateCustomer = function (token, fields, callback) {
    var req = request.post(options.url + '/1/customers/' + token);
    generateRequest(req, fields, callback);
  };

  /*this.deleteCardFromCustomer = function (token, cardToken, callback) {
    var req = request.delete(options.url + '/1/customers/' + token + '/cards/' + cardToken);
    generateRequest(req, {}, callback);
  };*/
